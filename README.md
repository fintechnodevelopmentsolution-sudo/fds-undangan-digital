# undangan-online
Custom Undangan Online

## Deploy ke GitHub Pages

Project ini memakai Vue + Vite dan sudah memiliki workflow GitHub Actions di `.github/workflows/deploy.yml`.

1. Push project ke branch `master`.
2. Buka repository GitHub, masuk ke **Settings > Pages**.
